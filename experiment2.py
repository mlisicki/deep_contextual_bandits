...
def main(_):
    ...
    for data_type in ['financial', 'jester',
                      'statlog', 'adult', 'covertype', 'census', 'mushroom', 'wheel', 'linear', 'sparse_linear']:
        ...
        try:
            ...
            pkl.dump({'desc': 'All the base models',
                      ...
                      'opt_actions_data': opt_rewards, 'opt_rewards_data': opt_actions},
